...
[`tarp()`](https://neuralsbi.pedrodelima.com/reference/tarp.md) against
the nominal credibility level. A calibrated posterior lies on the
diagonal; a curve above the diagonal means the posterior is too wide
