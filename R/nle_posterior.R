...
#'   prior can make `"proposal"` far slower than `"resample"` to find enough
#'   starting points, and it errors out once its draw budget is spent. The
#'   pool is 1000 draws, set with `n_pool`. `sbi` uses 10,000 *per chain*,
