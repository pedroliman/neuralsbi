...
check five states that span very different trajectories: Washington (site of
...
(a sharp early surge tied to Mardi Gras), and West Virginia (the last state
to report a case).
...
ggplot(post_pred_all, aes(date)) +
  ...
  labs(x = "date (2020)", y = "new cases per 8-day bin",
       title = "Posterior predictive check, 5 representative states",
...
<div class="figure">
<img src="figures/sir-rt-post-pred-states-1.png" alt="Posterior predictive check overlaying reported cases and the predictive interval for five representative states."  />
