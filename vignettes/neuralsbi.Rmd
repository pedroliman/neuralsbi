...
#>     beta=0.070  gamma=0.249  rho=0.042
...
A first pass at 8000 simulations often looks like this, and the remedy is more simulations before a bigger network. `vignette("diagnostics")` covers how to read these plots and what to do when a fit does not pass.
