...
* Fixed the hex logo (`man/figures/logo.png`): the "neuralsbi" wordmark was set low enough to clip against the hexagon's bottom point. Moved it up so it clears the border with margin.
